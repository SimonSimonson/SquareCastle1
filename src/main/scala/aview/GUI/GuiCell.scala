...
case class GuiCell(x: Int, y: Int, supervisor: SupervisorInterface, controller: ControllerInterface) extends GridPanel(1, 1) {
  ...
  val path = "./src/main/scala/aview/GUI/cardIMG/"
  //val path =  "/home/simon/IdeaProjects/SquareCastle1/src/main/scala/aview.GUI.GUI.GUI/cardIMG/"
  ...
  val cell: BorderPanel = new BorderPanel() {
    ...
    //listenTo(gamecontrol.controller)
